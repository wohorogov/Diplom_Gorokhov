...
CLIPBOARD = u'Сравнить с буфером обмена'
SELECTIONS = u'Сравнить выделенное'
SAVED = u'Сравнить с сохранённым'
FILE = u'Сравнить с файлом в проекте…'
TAB = u'Сравнить с открытой вкладкой…'
