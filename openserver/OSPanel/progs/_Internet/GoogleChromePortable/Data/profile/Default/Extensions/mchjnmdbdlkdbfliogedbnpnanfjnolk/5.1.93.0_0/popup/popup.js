        ...
        (function (elements) {
            var AreaHeader = (function (_super) {
                ...
                AreaHeader.prototype.render = function () {
                    ...
                    }, popup.ELEMENT('div', { className: "area-headerTitle" }, popup.ELEMENT('div', { className: "area-icon " + iconId }), popup.ELEMENT('div', { className: "area-title" }, this.props.title), popup.ELEMENT('div', { className: "clear" })), this.renderDetails());
                };
            ...
            var DntArea = (function (_super) {
                ...
                DntArea.prototype.renderAreaHeader = function () {
                    ...
                    return popup.ELEMENT(elements.AreaHeader, {
                        ...
                        expandable: data.taskEnabled,
                        onClick: data.taskEnabled ? function () { return _this.props.onExpand(); } : null,
                        iconId: 'dnt-area-icon',
                        iconDisabled: !data.taskEnabled ||
                            !data.blockingEnabled ||
                            data.thisSiteBlockingStatus !== 0,
                        text: this.getText(),
                        text2: this.getText2(),
                        smallText: this.getSmallText(),
                        onEnableButton: data.taskEnabled ? null : function () { return _this.onEnableTask(true); },
                        enableButtonLabel: l10n('PopupDntButtonEnableTask')
                    });
                };
                ...
                DntArea.prototype.onEnableTask = function (enable) {
                    this.props.controller.sendCommand(AreaId, 'EnableDntTask', [String(enable)]);
                };
                ...
                DntArea.prototype.getText = function () {
                    var data = this.getData();
                    if (!data.taskEnabled)
                        return l10n('PopupDntTextTaskDisabled');
                    if (isIncompatibleOrPartnerSite(data))
                ...
                DntArea.prototype.getSmallText = function () {
                    var data = this.getData();
                    if (!data.taskEnabled || !isIncompatibleOrPartnerSite(data))
                        return null;
            ...
            var AntiBannerArea = (function (_super) {
                ...
                AntiBannerArea.prototype.renderAreaHeader = function () {
                    ...
                    return popup.ELEMENT(elements.AreaHeader, {
                        ...
                        smallText: this.getSmallText(),
                        onEnableButton: data.taskEnabled ? null : function () { return _this.onEnableTask(true); },
                        enableButtonLabel: l10n('PopupAntiBannerButtonEnableTask')
                    });
                };
                ...
                AntiBannerArea.prototype.getText = function () {
                    var data = this.getData();
                    if (!data.taskEnabled)
                        return l10n('PopupAntiBannerTextTaskDisabled');
                    if (data.thisSiteBlockingStatus != 0)
    ...
    (function (popup) {
        ...
        var PopupView = (function () {
            ...
            PopupView.prototype.updateData = function (viewData) {
                if (!this.viewData)
                    this.viewData = {};
                for (var areaId in viewData)
                    if (viewData.hasOwnProperty(areaId))
                        this.viewData[areaId] = viewData[areaId];
            };
